...
**identYwaf** is a WAF identification tool that can recognize web protection type based on blind inference. Currently it supports more than 60 different protection products (e.g. `aeSecure`, `Airlock`, `CleanTalk`, `CrawlProtect`, `Imunify360`, `MalCare`, `ModSecurity`, `Palo Alto`, `SiteGuard`, `UrlScan`, `Wallarm`, `WatchGuard`, `Wordfence`, etc.), while the knowledge-base is constantly growing. It has been created as part of a research done while developing [sqlmap](https://github.com/sqlmapproject/sqlmap/).
